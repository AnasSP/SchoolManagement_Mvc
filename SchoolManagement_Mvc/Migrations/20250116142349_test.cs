        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentKeyId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherRegistrationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Selected = table.Column<bool>(type: "bit", nullable: false),
                    TeacherKeyId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ClassId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Enrolls_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "SessionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AssignGradeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignGrades", x => x.AssignGradeId);
                    table.ForeignKey(
                        name: "FK_AssignGrades_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "GradeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeacherSessionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TeacherId = table.Column<int>(type: "int", nullable: true),
                    SessionId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherSessions", x => x.TeacherSessionId);
                    table.ForeignKey(
                        name: "FK_TeacherSessions_Sessions_SessionId",
                        column: x => x.SessionId,
                        principalTable: "Sessions",
                        principalColumn: "SessionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignGrades_GradeId",
                table: "AssignGrades",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignGrades_TeacherId",
                table: "AssignGrades",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_TeacherKeyId",
                table: "Teachers",
                column: "TeacherKeyId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TeacherSessions_SessionId",
                table: "TeacherSessions",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherSessions_TeacherId",
                table: "TeacherSessions",
                column: "TeacherId");
        }
